...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    emitChanges: function emitChanges() {
      ...
      if (JSON.stringify(this.value) === JSON.stringify(this.values) || this.values == null) return; // Update filter state
        ...
        _c(
          "multiselect",
          {
            ...
            attrs: {
              ...
              selectGroupLabel: _vm.__("novaMultiselect.selectGroupLabel"),
              selectedLabel: _vm.__("novaMultiselect.selectedLabel"),
              deselectLabel: _vm.__("novaMultiselect.deselectLabel"),
              deselectGroupLabel: _vm.__("novaMultiselect.deselectGroupLabel")
            },
            on: {
...
Nova.booting(function (Vue, router, store) {
  Vue.component('nova-multiselect-filter-2', _components_MultiselectFilter__WEBPACK_IMPORTED_MODULE_0__["default"]);
});
    ...
    getInitialFilterValuesArray: function getInitialFilterValuesArray() {
      try {
        ...
        if (typeof this.filter.currentValue === 'string') {
          var value = this.filter.currentValue;
...
module.exports = __webpack_require__(/*! /Users/optimist/Dev/NovaDev/packages/nova-multiselect-filter/resources/js/filter.js */"./resources/js/filter.js");
