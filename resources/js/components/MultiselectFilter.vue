<template>
  <div class="outl1ne-multiselect-filter o1-pt-2 o1-pb-3 o1-relative">
    ...
    <!-- track-by="value" -->
    <!-- label="label" -->
    <!-- :groups="filter.groupSelect || false" -->
    <!-- :close-on-select="filter.max === 1 || !isMultiselect" -->
    <!-- :placeholder="filter.placeholder || filter.name" -->
    <!-- :mode="isMultiselect ? 'multiple' : 'single'" -->
    <!-- :max="filter.max || null" -->
    <!-- :limit="filter.optionsLimit || 1000" -->
    <!-- :limit-Text="count => __('novaMultiselectFilter.limitText', { count: String(count || '') })" -->
    <!-- :noResultsText="__('novaMultiselectFilter.noResult')" -->
    <!-- :noOptionsText="__('novaMultiselectFilter.noOptions')" -->
    <div class="o1-pt-2 o1-px-2 o1-flex o1-relative">
      <multiselect ref="multiselect" v-model="selected" :options="computedOptions" :searchable="true" append-to="body">
      </multiselect>
    </div>
  </div>
</template>
